...
const Introduction = () => {
  return (
    ...
    >
      ...
      <Typography marginTop="10px">Look at the following example:</Typography>
      <Box margin="0 auto" marginY="30px">
        ...
        >
          ...
          <Typography variant="h3" color="rgb(255, 62, 62)">
            [a]
          </Typography>
        </Box>
        <Box
      ...
      <Typography>
        ...
        , and "n" has its own symbol when used on its own.
      </Typography>
      <Typography>
        Now, each vowel has its own hiragana and katakana character, but for
      ...
      <Box margin="0 auto" marginY="30px">
        <Box
          sx={{ display: "flex", alignItems: "center", marginBottom: "7px" }}
        >
          <Typography variant="h3">k + a</Typography>
          <ArrowRightAltIcon fontSize="large" />
          <Typography variant="h3" color="rgb(255, 62, 62)">
            か [ka]
          </Typography>
        ...
        <Box
          sx={{ display: "flex", alignItems: "center", marginBottom: "7px" }}
        >
          <Typography variant="h3">k + i</Typography>
          <ArrowRightAltIcon fontSize="large" />
          <Typography variant="h3" color="rgb(255, 62, 62)">
            き [ki]
          </Typography>
        ...
        <Box
          sx={{ display: "flex", alignItems: "center", marginBottom: "7px" }}
        >
          <Typography variant="h3">k + u</Typography>
          <ArrowRightAltIcon fontSize="large" />
          <Typography variant="h3" color="rgb(255, 62, 62)">
            く [ku]
          </Typography>
        ...
        <Box
          sx={{ display: "flex", alignItems: "center", marginBottom: "7px" }}
        >
          <Typography variant="h3">k + e</Typography>
          <ArrowRightAltIcon fontSize="large" />
          <Typography variant="h3" color="rgb(255, 62, 62)">
            け [ke]
          </Typography>
        ...
        <Box
          sx={{ display: "flex", alignItems: "center", marginBottom: "7px" }}
        >
          <Typography variant="h3">k + o</Typography>
          <ArrowRightAltIcon fontSize="large" />
          <Typography variant="h3" color="rgb(255, 62, 62)">
            こ [ko]
          </Typography>
      ...
      <Typography fontWeight="700">But wait!</Typography>
      <Typography fontWeight="700" color="rgb(255, 62, 62)" marginBottom="10px">
        You might be wondering what the difference between Hiragana and Katakana
        is...
      </Typography>
      ...
      <Typography>
        Below, you can find the tables for Hiragana and Katakana that
        contain all the different types of symbols.{" "}
      </Typography>
      <Typography>
